...
const Sidebar = ({ sidebar, setSidebar }) => {
  return (
    <section
      ...
      {/* Sidebar Menu */}
      <SidebarLink to='/admin-panel'>Home</SidebarLink>
      <SidebarLink to='/admin-panel/add-item'>Add Item</SidebarLink>
      <SidebarLink to='/admin-panel/add-category'>Add Category</SidebarLink>
      <SidebarLink to='/admin-panel/manage-items'>Manage Items</SidebarLink>
