...
const ItemModal = ({ item, setItemModal }) => {
  ...
  return (
    <>
      ...
      ></div>
      <div className="max-w-[640px] mx-6 sm:mx-auto h-modal my-auto bg-white fixed top-0 right-0 bottom-0 left-0 z-[10000] overflow-y-scroll overflow-x-hidden scrollbar scrollbar-thumb-transparent scrollbar-track-transparent scrollbar-thin">
