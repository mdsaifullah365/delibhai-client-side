...
const ItemDescription = ({ description, name, price }) => {
  return (
    <div className="px-[calc(5.333vw-0.2666rem)] sm:px-[32.42px]">
      <div className="mt-[calc(6.4vw-0.32rem)] sm:mt-[38.912px]">
        <p className="text-[calc(8.533333vw-0.4266rem)] sm:text-[40px] font-bold">
          {name}
        </p>
        <p className="text-[calc(6.4vw-0.32rem)] sm:text-[28px]">
          ৳ {price} টাকা
        </p>
      </div>
